...
#ifndef _cnnshift_arr_ap_fixed_ap_fixed_16_4_5_3_0_config8_s_layerbrm_H_
#define _cnnshift_arr_ap_fixed_ap_fixed_16_4_5_3_0_config8_s_layerbrm_H_
#include <systemc>
#include <iostream>
#include <fstream>
#include "AESL_pkg.h"
...
struct cnnshift_arr_ap_fixed_ap_fixed_16_4_5_3_0_config8_s_layerbrm_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(cnnshift_arr_ap_fixed_ap_fixed_16_4_5_3_0_config8_s_layerbrm_core);
    cnnshift_arr_ap_fixed_ap_fixed_16_4_5_3_0_config8_s_layerbrm_core(sc_core::sc_module_name) {
        SC_METHOD(proc_dout);
...
SC_MODULE( cnnshift_arr_ap_fixed_ap_fixed_16_4_5_3_0_config8_s_layerbrm )
{
    ...
    SC_CTOR( cnnshift_arr_ap_fixed_ap_fixed_16_4_5_3_0_config8_s_layerbrm ) {
        meminst = new cnnshift_arr_ap_fixed_ap_fixed_16_4_5_3_0_config8_s_layerbrm_core <DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    cnnshift_arr_ap_fixed_ap_fixed_16_4_5_3_0_config8_s_layerbrm_core <DataWidth, AddressWidth, AddressRange>* meminst;

};

#endif //_cnnshift_arr_ap_fixed_ap_fixed_16_4_5_3_0_config8_s_layerbrm_H_
